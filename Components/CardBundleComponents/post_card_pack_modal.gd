...
@onready var card_pack_name: Label = %CardPackName
...
func _on_post_card_bundle_window_card_pack_button_pressed(pack_data: Dictionary) -> void:
	populate_card_labels(pack_data, "Pack")
...
func populate_card_labels(card_data: Dictionary, filter: String) -> void:
	...
	card_pack_name.text = card_data.name
...
func _on_list_for_sale_button_pressed() -> void:
	list_for_sale_button_pressed.emit(data_card, image_card, "Pack")
